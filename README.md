...
| 기능 구현·완성도 (functionality) | 10 | 소스 + 실행/테스트 | AI(절대 앵커, **동작 기능 수** 강조) |
| README·문서화 (documentation) | 10 | README/문서 | AI(절대 앵커) |

- **기본 점수 만점 = 50점** (실행 30 + AI 루브릭 20). 여기에 가산점 **최대 50점**(Azure 25 + MS 스택 25)이 더해집니다.
